...
New-Item -ItemType Directory -Force -LiteralPath $AppDir | Out-Null
...
New-Item -ItemType Directory -Force -LiteralPath $PanelDir | Out-Null
foreach ($m in @("products","orders","users")) {
  New-Item -ItemType Directory -Force -LiteralPath (Join-Path $PanelDir $m) | Out-Null
}
